...
public class KotlinClientCoroutinesRxCodegen extends AbstractKotlinCodegen {
    ...
    /**
     * Constructs an instance of `KotlinClientCoroutinesRxCodegen`.
     */
    public KotlinClientCoroutinesRxCodegen() {
        super();

        artifactId = "kotlin-client-pj";
        packageName = "io.swagger.client";

        outputFolder = "generated-code" + File.separator + "kotlin-client-pj";
        modelTemplateFiles.put("model.mustache", ".kt");
        apiTemplateFiles.put("api.mustache", ".kt");
        modelDocTemplateFiles.put("model_doc.mustache", ".md");
        apiDocTemplateFiles.put("api_doc.mustache", ".md");
        embeddedTemplateDir = templateDir = "kotlin-pj";
    ...
    public String getHelp() {
        return "Generates a kotlin pj client.";
    }
